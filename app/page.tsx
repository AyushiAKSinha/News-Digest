...
const API_URL = "https://dmthxkovdjynxiuoldna.hasura.ap-south-1.nhost.run/v1/graphql";
...
export default function Home() {
  ...
  const getSentimentColor = (sentiment) => {
    ...
    if (sentiment.includes("neutral")) return "bg-blue-100 text-blue-800";
    return "bg-gray-100";
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold text-center mb-2">Failed to load news</h2>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">AI News Digest</h1>
        ...
        {summaries.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-xl shadow-md">
            <p className="text-gray-600">No news summaries available at the moment.</p>
          </div>
        ) : (
              ...
              >
                <div className="p-6">
                  <div className="flex items-center mb-3">
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-500">{item.Article?.source || "Unknown Source"}</span>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSentimentColor(item.sentiment)}`}>
                      {getSentimentIcon(item.sentiment)}
                      <span className="ml-1">{item.sentiment || "Unknown"}</span>
                    </div>
                  </div>
